  ...
  return (
    <div className="page">
      ...
      <div className="section-header">
        <div className="section-label">Community Challenges</div>
        <span className="section-tag">Everyone together</span>
      </div>
      {community.map(c => {
        const pct = progressPct(c.community_progress, c.target);
        const myPct = c.my_progress !== null ? progressPct(c.my_progress, c.target) : null;
        return (
      ...
      <div className="section-header" style={{ marginTop: 8 }}>
        <div className="section-label">Personal Challenges</div>
